...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b>Usage:</xd:b> Apply this stylesheet to a DITAMAP, to transform all referenced files of type TOPIC into one .rst file.</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:template match="map">
        <xsl:result-document href="../output/sdk.rst">
