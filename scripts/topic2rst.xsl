...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b>Usage:</xd:b> Apply this stylesheet to one DITA TOPIC, to transform it into an .rst file.</xd:p>
        </xd:desc>
    </xd:doc>
...
<!--    <xsl:template match="*/text()">
    ...
    <xsl:template match="topic">
        <xsl:variable name="filename" select="concat('../source/rst/',@id,'.rst')" />
